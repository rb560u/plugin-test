...
from contrail_tempest_plugin.services.contrail.json.domain_client import \
    DomainClient
...
class DomainContrailTest(base.BaseContrailTest):

    @classmethod
    def setup_clients(cls):
        super(DomainContrailTest, cls).setup_clients()
        cls.client = DomainClient(
            cls.auth_provider,
    ...
    def test_create_domain(self):
        ...
        rbac_utils.switch_role(self, switchToRbacRole=True)
        try:
            resp, dm_uuid = self.client.create_domain()
            was_created = resp.status == 200
        finally:
            rbac_utils.switch_role(self, switchToRbacRole=False)
            if was_created:
                self.client.delete_domain(dm_uuid)
    ...
    def test_show_domain(self):
        ...
        rbac_utils.switch_role(self, switchToRbacRole=True)
        try:
            self.client.show_domain(dm_uuid)
        finally:
            rbac_utils.switch_role(self, switchToRbacRole=False)
            if was_created:
                self.client.delete_domain(dm_uuid)
    ...
    def test_update_domain(self):
        ...
        rbac_utils.switch_role(self, switchToRbacRole=True)
        try:
            self.client.update_domain(dm_uuid)
        finally:
            rbac_utils.switch_role(self, switchToRbacRole=False)
            if was_created:
                self.client.delete_domain(dm_uuid)
    ...
    def test_delete_domain(self):
        ...
        rbac_utils.switch_role(self, switchToRbacRole=True)
        try:
            resp, _ = self.client.delete_domain(dm_uuid)
