...
class NetworkPolicyTest(base.BaseContrailTest):

    @classmethod
    def setup_clients(cls):
        super(NetworkPolicyTest, cls).setup_clients()
        cls.client = NetworkPolicyClient(
            cls.auth_provider,
